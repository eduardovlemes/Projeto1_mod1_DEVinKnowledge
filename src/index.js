...
const initialValues = [
    {
        ...
        skill: 'CSS',
        categoria:'FrontEnd',
        descricao: 'A diferença crucial entre flexbox e grid, tirando o fato do primeiro ser unidirecional e o outro bi-direcional, é que o controle do layout no grid vem do container e no flexbox vem dos elementos.',
    ...
    },
    {
        ...
        skill: 'Comunicação',
        categoria:'SoftSkill',
        descricao: 'Um bom comunicador é sempre um bom ouvinte. Quem sabe ouvir não perde informações, faz perguntas apropriadas e entende o interlocutor. Você pode criar empatia com frases como "Fale mais sobre esse assunto" ou "Estou interessado no que você diz" Fale mais detalhes para entender por que você pensa assim.',
        video: 'https://www.youtube.com/watch?v=H5L-CfmklKc'
    },
    {
        titulo: '5 habitos que todo dev deveria ter.',
        skill: 'Profissional',
        categoria:'SoftSkill',
